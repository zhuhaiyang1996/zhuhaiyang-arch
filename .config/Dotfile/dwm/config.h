...
static const unsigned int barheight   = 40; /* height of bar */
static const char *fonts[]          = { "UbuntuMono Nerd Font Mono:size=13" };
static const char dmenufont[]       = "UbuntuMono Nerd Font Mono:size=13";
...
static const char *dmenucmd[] = { "rofi","-show","drun","-theme","oxide", NULL };
static const char *termcmd[]  = { "kitty", NULL };
static const char *browser[]  = { "microsoft-edge-dev", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,             XK_p,                     focusstack,     {.i = -1 } }, //切换focus到不同的程序窗口
	{ MODKEY,             XK_Up,                    incnmaster,     {.i = +1 } },
	{ MODKEY,             XK_Down,                  incnmaster,     {.i = -1 } }, //改变窗口布局
	{ MODKEY,             XK_minus,                 setmfact,       {.f = -0.05} },
	{ MODKEY,             XK_equal,                 setmfact,       {.f = +0.05} },//左/右方向键，调整程序窗口的大小
	{ MODKEY|ShiftMask,             XK_Return,      zoom,           {0} }, //将当前所在focus的窗口提升为主窗口(左边那个占比最大的窗口就是“主窗口”)
